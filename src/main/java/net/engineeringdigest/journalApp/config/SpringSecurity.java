...
public class SpringSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // csrf - Cross-Site Request Forgery - it expects bydefault inside the spring security that
        //        you have also send a token. And by default it stays enabled.
    }
...
// A configuration security to integrate everything with spring security
